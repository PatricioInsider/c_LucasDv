...
Grafos
son TDA's
no jerarquico tampoco lineal 
comunicacion entre ellos, encontrar caminos
relacionar datos entre ellos, conformar el grafo y encontrar los mejores caminos, admite conexiones entre todos los nodos 
un conjunto que agrupa los datos y los arcos que juntan a los datos con los arcos(vertices)
grado numero de arcos
